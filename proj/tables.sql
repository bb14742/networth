...
CREATE TABLE IF NOT EXISTS `invest`.`inv_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `inv_category_idx1` (`category_desc` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `invest`.`symbols` (
  ...
  `active_symbol_ind` TINYINT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `invest`.`broker` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `broker_idx1` (`broker_nm` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `invest`.`inv_acct_class` (
  ...
  UNIQUE INDEX `inv_acct_class_idx1` (`broker_id` ASC, `inv_acct_class_nm` ASC, `taxable_ind` ASC),
...
CREATE TABLE IF NOT EXISTS `invest`.`investor` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `investor_idx1` (`first_nm` ASC, `last_nm` ASC))
ENGINE = InnoDB;
